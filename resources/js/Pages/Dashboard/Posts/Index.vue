    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between gap-3">
                <h2 class="text-lg font-bold tracking-tight text-zinc-900">My Posts</h2>
                <Link
        ...
        <div class="mx-auto max-w-5xl">
            ...
            <div v-if="posts.data.length === 0" class="card p-14 text-center">
                <div class="mx-auto inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-100 to-violet-100 text-indigo-600">
                    <svg class="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L6.832 19.82a4.5 4.5 0 01-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 011.13-1.897L16.863 4.487zm0 0L19.5 7.125" />
                    </svg>
                </div>
                <p class="mt-5 text-lg font-bold text-zinc-900">No posts yet</p>
            ...
            <div v-else class="card overflow-hidden">
                <ul class="divide-y divide-zinc-100">
                    <li
                        ...
                        :key="post.id"
                        class="flex flex-col gap-4 p-5 transition hover:bg-zinc-50/60 sm:flex-row sm:items-center sm:justify-between"
                    >
                        <div class="min-w-0">
                            ...
                            <Link
                                ...
                                class="mt-2 block truncate text-lg font-bold text-zinc-900 transition hover:text-indigo-600"
                            >
                                {{ post.title }}
                            </Link>
                        ...
                        <div class="flex shrink-0 flex-wrap items-center gap-2">
                            ...
                            <Link
                                :href="route('dashboard.posts.edit', post.id)"
                                class="rounded-xl bg-zinc-100 px-3 py-2 text-sm font-semibold text-zinc-700 transition hover:bg-zinc-200"
                            >
                                Edit
                            </Link>
                            <Link
